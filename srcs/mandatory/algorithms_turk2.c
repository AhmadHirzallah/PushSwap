...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/22 21:26:45 by ahirzall          #+#    #+#             */
/*   Updated: 2025/02/22 21:26:46 by ahirzall         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static long	compute_push_cost_b_to_a(t_list_node *b_node, t_list_node *a_target,
		t_stacks *s)
{
	t_stacks_oprs	a_dir;
	t_stacks_oprs	b_dir;
...
t_list_node	*select_candidate_b_to_a(t_stacks *s, long *min_cost)
{
	...
	*min_cost = LONG_MAX;
	...
	{
		current->push_cost = compute_push_cost_b_to_a(current, current->target,
				s);
